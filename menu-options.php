...
<body>
	...
	<header class="header menu_fixed">
		...
		<ul id="top_menu">
			<li><a href="register.html" class="btn_add">Add Listing</a></li>
	...
	<main class="pattern">
		...
		<div class="container margin_60_35">
			...
			<div class="row add_bottom_30">
				...
				<div class="col-lg-3">
					<a ref="detail-shop.html" class="grid_item small">
						<figure>
		...
		<div class="call_section">
			<div class="wrapper">
				<div class="container margin_80_55">
					...
					<!-- /row -->
					<p class="text-center add_top_30 wow bounceIn" data-wow-delay="0.5s"><a href="register.html" class="btn_1 rounded">Register Now</a></p>
				</div>
