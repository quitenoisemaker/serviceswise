		   ...
		   <div class="container" style="padding-top: 8%;">
			   <div class="row">
				   <div class="col-lg-3 col-md-4 col-10">
					   <h4><strong><br>
					   		<?php 
					$cat=trim(strval($_GET['cat']));
					$cati= str_replace(_, ' ', $cat);
					$sql="select * from user where services='".$cati."'";
					$result=$conn->query($sql);
                	if($result->num_rows >-1){
                		echo htmlentities($result->num_rows);
                	}
                		?>
					   </strong> result(s) for all <?php echo htmlentities($cati)."s"; ?></h4>
				   </div>
				   <div class="col-lg-5 col-md-5 col-2">
				   	<form method="post" action="general-filter.php" style="margin-left: 20%;"><br>
					   <a href="#" class="search_mob btn_search_mobile"></a> <!-- /open search panel -->
						<div class="row no-gutters custom-search-input-2 inner">
							<div class="col-lg-8">
								<div class="wide form-group" style="margin-left: 20% !important;">
			   ...
			   <!-- /row -->
			   <form action="general-filter.php" method="post">
		...
		<div class="container margin_60_35">
			...
			<div class="row">
				...
				<?php 
					$cat=trim(strval($_GET['cat']));
					$cati= str_replace(_, ' ', $cat);
					$sql="select * from user where services='".$cati."' order by RAND()";
					$result=$conn->query($sql);
