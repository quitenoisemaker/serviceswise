	   ...
	   <!-- /results -->
				...
				<ul class="clearfix">
					...
					<li>
						<div class="layout_view">
							...
							<a href="row-listings-isotope-2.html"><i class="icon-th-list"></i></a>
		...
		<div class="container margin_60_35">
			<div class="category_filter">
				...
				<label class="container_radio">Shops
					<input type="radio" id="shops" name="categories_filter" value="shops" data-filter=".shops">
					<span class="checkmark"></span>
				</label>
				<label class="container_radio">Hotels
					<input type="radio" id="hotels" name="categories_filter" value="hotels" data-filter=".hotels">
					<span class="checkmark"></span>
				</label>
				<label class="container_radio">Restaurants
					<input type="radio" id="hh" name="categories_filter" value="hh" data-filter=".restaurants">
					<span class="checkmark"></span>
				</label>
				<label class="container_radio">Bars
					<input type="radio" id="bars" name="categories_filter" value="bars" data-filter=".bars">
					<span class="checkmark"></span>
				</label>
				<label class="container_radio">Events
					<input type="radio" id="events" name="categories_filter" value="events" data-filter=".events">
					<span class="checkmark"></span>
				</label>
			</div>
			<div class="isotope-wrapper">
			<div class="row">
				<div class="col-xl-4 col-lg-6 col-md-6 isotope-item <?php echo 'restaurants' ?> ">
				...
				<!-- /strip grid -->
				<div class="col-xl-4 col-lg-6 col-md-6 isotope-item shops">
					<div class="strip grid">
						<figure>
							<a href="#0" class="wish_bt"></a>
				...
				<!-- /strip grid -->
				<div class="col-xl-4 col-lg-6 col-md-6 isotope-item hotels">
					<div class="strip grid">
						<figure>
							<a href="#0" class="wish_bt"></a>
				...
				<!-- /strip grid -->
				<div class="col-xl-4 col-lg-6 col-md-6 isotope-item events">
					<div class="strip grid">
						<figure>
							<a href="#0" class="wish_bt"></a>
