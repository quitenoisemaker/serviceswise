...
if($result->num_rows >-1){
                	$total_location=$result->num_rows;
                	}
                		?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($total_location);?></div>
...
if($result->num_rows >-1){
                	$total_category=$result->num_rows;
                		...
                		?>
													...
													<div class="stat-panel-number h1 "><?php echo htmlentities($total_category);?></div>
